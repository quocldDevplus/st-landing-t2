...
const Portforlio = () => {
    ...
    //         teamCaptionHide:
    //             "IOT Space is a coworking space that promotes creativity and nurtures knowledge. It's also a perfect place for
    //             entrepreneurial individuals to expand their professional networks.",
    //     },
    //     {
    //         id: 'Portforlio-3',
    ...
    //         teamCaptionHide: 'Chatbot to communicate with users,
    //         reply questions automatically.',
    //     },
    //     {
    //         id: 'Portforlio-5',
