...
const StDigital = () => {
  ...
  return (
    <Row className="Stdigital-container">
        ...
        <Row className="Stdigital-title-top">
          ...
          <Row className="Stdigital-section-content">
            <Row className="Stdigital-section row">
              <Col className="Stdigital-page-main">
                <Row className="Stdigital-content-text">
                  <p>
                    <strong>ST Digital</strong>
                    "offers professional offshore digital marketing services that
                    can make your business stand out from the digital crowd. Our
                    digital marketing services range from search engine
                    optimisation (SEO), social media services, email marketing
                    services, content outsourcing, and graphic design services,
                    which aids in creating organic engagement and direct traffic
                    towards your website and its content. Through partnering
                    with ST, we can help you create a good lasting impression
                    online and give you an edge over your top competitors!"
                  </p>
                </Row>
                <Col className="Stdigital-module-three-columns">
                  <Row className="Stdigital-module row">
                    {list &&
                      list.map((item, index) => {
                        return (
                  ...
                  <Row className="Stdigital-module-2 row">
                   ...
                   <Col className="Stdigital-module-block">
                     <Col className="Stdigital-module-3 row ">
