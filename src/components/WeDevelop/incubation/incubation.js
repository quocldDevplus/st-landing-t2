...
import FE02TypicalChild from "../bang/FE02TypicalChild";
    ...
    ([
        {
            ...
            description: "Targeting early-stage startups in multiple sectors, our goal is to support founders with practical education and mentorship from idea validation, MVP development, and business validation stage.",
        },
        {
            id:"inc2",
            img: "https://stunited.vn/wp-content/uploads/2019/09/icons-400sq-record-keeping-office-space-150x150.png",
            title: "Coworking Space",
            description: "Based on coworking platform with IoT Space, Nomad Space... provides not only space for working but also an opportunity for members to thrive by exploring collaboration, learning, and access to our strategic network.",
        },
        {
            id:"inc3",
            img: "https://stunited.vn/wp-content/uploads/2019/09/Money-512-150x150.png",
            title: "Strategic Funding",
            description: " ST United is considering an early stage VC fund that invests in technology startups in Vietnam, particularly Danang, at their early and growth stages. We provide funding, and assistance by establishing strategic partnerships to help startups scale their businesses",
        },
  ...
  return (  
    <div className="incubation--container">
        <Row className="banner--container">
            <Col className="banner--background">
            </Col>
        </Row>
                ...
                <Row className="incubation--content">
                    ...
                    <Col className="incubation--description" md={12} sm={12} xs={12}>
                            ...
                            <Col className="incubation--des">
                                <p className="p1">
                                    <span className="s1">
                                        ...
                                        still keep intense aspiration how to apply the high technologies to solve the society problem in Vietnam. 
                                    </span>
                                </p>
                                <p className="p1">
                                    <span className="s1">
                                    ...
                                    <strong> ST United </strong>
                                    provides incubator programs for budding entrepreneurs. 
                                    The program focuses on providing resources and support for startups in terms of business modeling, 
                        ...
                        <Row className="incubating--project">
                            <Col className="incubating--cover">
                                <FE02TypicalChild
                                listContainerFe02={list2}
                                SetListContainerFe02={setList2}
                                />
                            </Col>
                        </Row>
                    </Col>
