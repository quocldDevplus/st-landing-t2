...
const LetsTalk = () => {
    ...
    return (
        <div className="letstalk-container" style={{ margin: '0' }}>
            ...
            />
            <div className="letstalk-container container">
                    ...
                    <Row ClassName="letstalk-title">
                        <Col sm={12} className="letstalk-sm-12">
                            <Breadcrumb className="letstalk-breadcrumb">
                                <Breadcrumb.Item className="letstalk-breadcrumb__unactive" href="https://stunited.vn/">
                                    Home
                                </Breadcrumb.Item>
                                        ...
                                        <Col md={8} ClassName="letstalk-input">
                                            ...
                                            <form onSubmit={handleSubmit} size="sm" className="letstalk-form">
                                                <div className="letstalk-column-inner">
                                                    ...
                                                    />
                                                    <span role="alert" class="letstalk-form__input-validate-error">
                                                        {formErrors.name}
                                                    </span>
                                                    ...
                                                    <div className="mb-4">
                                                        ...
                                                        <textarea
                                                            ...
                                                            onChange={handleChange}
                                                            class="letstalk-form__text-area"
                                                        ></textarea>
                                                        <span role="alert" class="letstalk-form__input-validate-error">
                                                            {formErrors.message}
                                                        </span>
